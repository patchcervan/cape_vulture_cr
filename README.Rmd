...
Some of the processing and fitting scripts take quite long to run. Therefore, run only if completely necessary and go find something to do. In addition, some of the scripts are better suited to run in a high performance computing environment, because the are very demanding of RAM memory. These will be flagged throughout the document, to proceed with care.
